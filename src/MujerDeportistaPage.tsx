...
const MujerDeportistaPage: React.FC = () => {
  ...
  const products = [
    ...
    { id: 8, imageSrc: 'https://contents.mediadecathlon.com/p2375385/k$b957120ad9a76daa1eba910fff6cf74e/traje-de-bano-entero-de-natacion-mujer-kamiye-500-azulslashverde.jpg?format=auto&quality=40&f=800x800', price: '$16.000', title: 'Traje de baño mujer 500 azul' },
    ...
    { id: 13, imageSrc: 'https://contents.mediadecathlon.com/p2375390/k$a2edd931c8700a0b52a71c97f68540da/traje-de-bano-entero-de-natacion-mujer-kamiye-500-azulslashverde.jpg?format=auto&quality=40&f=800x800', price: '16.000', title: 'Traje de baño mujer 500 negro' },
    ...
    { id: 18, imageSrc: 'https://contents.mediadecathlon.com/p2457060/k$fce91c7f5ae684f459229006284daeb4/traje-de-bano-surf-mujer.jpg?format=auto&quality=40&f=800x800', price: '$27.000', title: 'Traje de baño surf mujer' },
    { id: 19, imageSrc: 'https://contents.mediadecathlon.com/p2048909/k$989ea1e93e2e7bee86c9946d43e01f90/chaqueta-cortaviento-running-kalenji-run-wind-mujer-negro.jpg?format=auto&quality=40&f=800x800', price: '$16.000', title: 'Cortavientos running mujer negro' },
  ...
  const handleGoBack = () => {
    navigate(-1); // Utiliza navigate con el argumento -1 para navegar hacia atrás
  };
